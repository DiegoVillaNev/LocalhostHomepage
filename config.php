...
// LocalHomePage root: './'
$projRoot = '/usr/local/var/www/';

// Directory name(s)
$dirArray = array("/Users/diegovn/Sites/sites/*");
...
*/
$iconsArray = array( 'favicon.ico', 'adonis.jpg', 'vue.png', 'angular.png', 'php.png', 'slim.png', 'html.png', 'folder.png');
...
//  array( 'name' => 'Tool', 'url' => 'http://example.com/' ),
    array('name' => 'phpMyAdmin',        'url' => 'http://localhost/phpmyadmin/index.php'),
    array('name' => 'Local PHP Info',    'url' => '/RESTfulBitacoras/test.php'),
    array('name' => 'My GitHub Profile', 'url' => 'http://github.com/DiegoVillaNev'),
    array('name' => 'My Website',        'url' => 'http://diegovillanev.github.io'),
);
